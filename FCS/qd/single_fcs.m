...
%g2=single_fcs(s_N,e_N,t_min,t_max,taumin,taumax,N,plot_flag,normalize_flag),

function [tau,g2]=single_fcs(s_N,e_N,t_min,t_max,taumin,taumax,N,plot_flag,normalize_flag,linear),

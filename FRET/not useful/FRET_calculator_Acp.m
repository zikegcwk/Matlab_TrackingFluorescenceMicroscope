%function FRET_calculator look into fluo data file and calculate FRET
...
function [Don_pk_C,Acp_pk_C,FRET_e,figure_h]=FRET_calculator(filenum,dt,level)
...
if N_pk<=12
    ...
    figure_h=figure('Name',strcat(cd,' data', num2str(filenum),' TOP 12'),'Position',[1 scrsz(4)-1270 scrsz(3) scrsz(4)]); hold all; clf;
    for j=1:1:12

%function FRET_calculator look into fluo peaks in Donor channel and calculate FRET
...
function [Don_pk_C,Acp_pk_C,FRET_e,figure_h]=FRET_calculator_Don(filenum,dt,level)

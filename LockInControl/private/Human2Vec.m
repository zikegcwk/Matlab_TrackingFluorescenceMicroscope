% [axy, az] = Human2Vec(HumanStruct) (private)
% returns into [axy, az] a pair of vectors suitable for internet
% communication with the srsserv server.  Input is a human-readable
% structure containing lockin parameters according to the LOCKIN_PARAMS
% global variable format.
%
% See also Vec2Human, GetLockInSettings, SetLockIn, LockInGUI

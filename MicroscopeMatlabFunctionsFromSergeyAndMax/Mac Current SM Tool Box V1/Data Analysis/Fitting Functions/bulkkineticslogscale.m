...
plot2 = plot(xvalueshigh,ysinglehigh,'Color',[1 0 0],'LineWidth',1,'Parent',axes1,'DisplayName','single exponential');
plot6 = plot(xvalueshigh,singleresidualhigh,'--r','Parent',axes2,'DisplayName','single exponential','LineWidth',1);


% Create plot single exponential
plot2 = plot(xvalueslow,ysinglelow,'Color',[1 0 0],'LineWidth',1,'Parent',axes3,'DisplayName','single  exponential');
plot8 = plot(xvalueslow,singleresiduallow,'--r','Parent',axes4,'DisplayName','single exponential','LineWidth',1);
...
plot1 = plot(xvalueshigh,ystretchedhigh,'Color','m','LineWidth',1,'Parent',axes1,'DisplayName','double exponential');
plot5 = plot(xvalueshigh,stretchedresidualhigh,'--m','Parent',axes2,'DisplayName','double exponential','LineWidth',1);

                
% Create plot double exponential
plot1 = plot(xvalueslow,ystretchedlow,'Color','m','LineWidth',1,'Parent',axes3,'DisplayName','double exponential');
plot7 = plot(xvalueslow,stretchedresiduallow,'--m','Parent',axes4,'DisplayName','double exponential','LineWidth',1);
   

%create annotation labels
%a = ['k = ' num2str(round(100*singlefithigh)/100)];
b = ['k = ' num2str(round(100*stretchedfithigh(1))/100) '   \beta = ' num2str(round(100*stretchedfithigh(2))/100)];
...
%create annotation labels
b = ['k = ' num2str(round(100*stretchedfitlow(1))/100)  '   \beta = ' num2str(round(100*stretchedfitlow(2))/100)];
...
% Create plot double exponential
plot1 = plot(xvalueshigh,ydoublehigh,'Color',[0 0 1],'LineWidth',1,'Parent',axes1,'DisplayName','double exponential');
plot5 = plot(xvalueshigh,doubleresidualhigh,'--b','Parent',axes2,'DisplayName','double exponential','LineWidth',1);

                
% Create plot double exponential
plot1 = plot(xvalueslow,ydoublelow,'Color',[0 0 1],'LineWidth',1,'Parent',axes3,'DisplayName','double exponential');
plot7 = plot(xvalueslow,doubleresiduallow,'--b','Parent',axes4,'DisplayName','double exponential','LineWidth',1);
...
% Create textbox
annotation1 = annotation(figure1,'textbox','Position',[0.1 0.35 0 0],'FitHeightToText','on','String',{b,d},'LineStyle','none',...
...
annotation2 = annotation(figure1,'textbox','Position',[0.59 0.35 0 0],'FitHeightToText','on','String',{b d },'LineStyle','none',...
'VerticalAlignment','baseline','FontSize',10,'Color','b');   
...
% Create plot double exponential
plot1 = plot(xvalueshigh,ytriplehigh,'Color',[0 0 1],'LineWidth',1,'Parent',axes1,'DisplayName','double exponential' , 'Color','g');
plot5 = plot(xvalueshigh,tripleresidualhigh,'--b','Parent',axes2,'DisplayName','double exponential','LineWidth',1 , 'Color','g');

                
% Create plot double exponential
plot1 = plot(xvalueslow,ytriplelow,'Color',[0 0 1],'LineWidth',1,'Parent',axes3,'DisplayName','double exponential' , 'Color','g');
plot7 = plot(xvalueslow,tripleresiduallow,'--b','Parent',axes4,'DisplayName','double exponential','LineWidth',1 , 'Color','g');

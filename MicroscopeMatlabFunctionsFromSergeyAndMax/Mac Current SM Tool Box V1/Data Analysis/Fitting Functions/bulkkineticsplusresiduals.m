function  output = bulkkineticsplusresiduals(datasource,file_id, fps)
...
annotation4 = annotation(figure1,'textbox','Position',[0.79 0.1 0.1 0.1],'FitHeightToText','on','String',{f,g},'LineStyle','none');

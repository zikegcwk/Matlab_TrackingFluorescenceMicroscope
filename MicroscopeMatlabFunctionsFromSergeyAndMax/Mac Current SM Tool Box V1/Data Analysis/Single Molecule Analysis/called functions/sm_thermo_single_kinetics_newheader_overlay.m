...
ylabel(axes1,'Change in \Delta G Kcal/mol','FontSize',10)
xlim(axes1,xrange);
ylim(axes1,xrange);
hold(axes1,'all');
...
annotation(figure2,'textbox','Position',[0.1 .95 0.9 0.03],'FitHeightToText','on','String',strcat(title, ' Concat Overlay'),'LineStyle','none');
clipboard('copy',strcat(title, ' Concat Overlay'))

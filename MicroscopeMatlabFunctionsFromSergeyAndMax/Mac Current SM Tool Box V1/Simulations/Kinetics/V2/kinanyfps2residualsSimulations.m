function  output = kinanyfps2residualsSimulations(alltracesnonines,alltraces,time)
...
%place holders to prevent delating varlabies
fps=1;
concentration=1;
...
%end
backwards = 0 % what is this doing?
...
B=alltraces; % variables name change
...
A = alltracesnonines; % variables name change
...
%   fit with single and double exponenetials
                        ...
                        [doublefithigh, resnormhigh] = lsqcurvefit(@doubleexponential,[0 0.001 0.001],hightable(:,1),hightable(:,4),[0 0.001 0.001]); %lsqcurvefit(@function,[GUESSES],xdata,ydata)
                        resnormhigh
...
%   fit with single and double exponenetials
                        ...
                        [doublefitlow, resnormlow, residuallow] = lsqcurvefit(@doubleexponential,[0.6,30,0.1],lowtable(:,1),lowtable(:,4));
                        resnormlow
                        residuallow;

function out = zoom_connect(varargin)
...
case 'down'
    ...
    limits = zoom_connect(fig,'getlimits');
...
case 'on',
    ...
    set(fig,'windowbuttondownfcn','zoom_connect(gcbf,''down'')', ...
...
case 'xon',
    zoom_connect(fig,'on') % Set up userprop
    set(fig,'windowbuttondownfcn','zoom_connect(gcbf,''xdown'')', ...
        'windowbuttonupfcn','ones;', ...
...
case 'yon',
    zoom_connect(fig,'on') % Set up userprop
    set(fig,'windowbuttondownfcn','zoom_connect(gcbf,''ydown'')', ...
        'windowbuttonupfcn','ones;', ...
        'windowbuttonmotionfcn','','buttondownfcn','',...
        'interruptible','on');
    set(ax,'interruptible','on')
...
list = zoom_connect(fig,'getconnect'); % Circular list of connected axes.
if zoomx,

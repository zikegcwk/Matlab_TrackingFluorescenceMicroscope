function output = NonLinFRETFilter1a(filenumber1,filenumberlast,K,M,p)
...
%          return
    %Data(3,100:120)
    outputfilename = strcat('(NLFF1a)(',num2str(K),',',num2str(M),',',num2str(p),')cascade',num2str(ind),'(4).traces');

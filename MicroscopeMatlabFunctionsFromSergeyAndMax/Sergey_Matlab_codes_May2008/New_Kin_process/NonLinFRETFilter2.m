function output = NonLinFRETFilter2(filenumber1,filenumberlast,window,M,p)
...
%          return
    %Data(3,100:120)
    outputfilename = strcat('(NLFF2)(',num2str(window),',',num2str(M),',',num2str(p),')cascade',num2str(ind),'(4).traces');

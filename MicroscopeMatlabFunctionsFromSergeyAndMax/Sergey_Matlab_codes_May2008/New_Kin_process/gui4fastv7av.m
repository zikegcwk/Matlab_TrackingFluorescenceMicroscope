function varargout = gui4fastv7av(varargin)
%Sergey (Feb 2008) This script is used only for displaying images of movies
%averaged obver the whole length
...
% GUI4FASTV7AV Application M-file for gui4fastv7av.fig
%    FIG = GUI4FASTV7AV launch gui4fastv7av GUI.
%    GUI4FASTV7AV('callback_name', ...) invoke the named callback.

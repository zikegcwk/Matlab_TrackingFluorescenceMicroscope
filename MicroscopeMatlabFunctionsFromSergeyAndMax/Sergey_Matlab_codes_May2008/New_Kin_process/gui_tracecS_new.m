...
handles.crosstalk = 0.01; % Bernie what does this do? It is the crosstalk. SERGEY changes based on bleached state 
handles.first = 1;
handles.last = len;
handles.m = 1;
...
xlimits(1) = 21%+laseron;%SERGEYTEMP
...
lightsoff = find(handles.total_I((20+laseron):length(handles.total_I)) <0.1, 1, 'first');%SERGEYTEMP
...
%     dog = 0
pushbutton14_Callback(handles.pushbutton14, eventdata, handles);%SERGEYTEMP - finds laser off instead
%     cat = 0
handles = guidata(gcf);
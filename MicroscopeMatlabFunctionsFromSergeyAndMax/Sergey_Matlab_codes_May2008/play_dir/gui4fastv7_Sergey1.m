function varargout = gui4fastv7_Sergey1(varargin)
...
% % % %     cd(newdir);
    ...
    localbackgrounds = zeros(1+2*handles.num,handles.NumFrames);
...
case 9 % Batch analysis for decimal locations
    ...
    for i=1:number(1),
        ...
        set(handles.popupmenu2,'Value',7); % Locate SERGEYTEMP - donor! acceptor molecules, decimal precision
        popupmenu2_Callback(handles.popupmenu2, eventdata, guidata(handles.popupmenu2), varargin);
        handles=guidata(handles.popupmenu2);

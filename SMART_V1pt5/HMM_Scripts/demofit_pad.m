...
%% specify data
params.data = x2; %x is T by num_channels, column 1 is acceptor (red), column 2 is donor (green)
...
params.paramsErrorToBoundAuto = '(a(2,1),a(1,2))';%'(a(1,2),a(2,1))';%'(a(1,2),a(2,1))';%'(a(1,2),a(2,1)),e(1,1,1),e(2,1,1)'; %a's are plotted together on 2-d plot, e's are plotted on 1-d plots

...
function [tags,T]=Markov_Hairpin(lifetime_high, lifetime_low, F_high, F_low, T_total, filenum)
...
save(sprintf('data_%g', filenum), 'T','tags', 'lifetime_high', 'lifetime_low', 'F_high', 'F_low', 'T_total', 'filenum');

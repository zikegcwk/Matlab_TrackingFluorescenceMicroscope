function [atraces,D,Dnoise,gammac,gammap,L,noiseDensity,Istats,PlaserStats,StageStats]=analyzeTraces_smart_plot(traces,savemode,savefile)
tic
...
%         Plaser=Plaser(ix);
        ...
        [D_fit, D_noise, gammavec_fit, L_accuracy, noiseD] = msdfit_EB_smart(dT, DX, DY, DZ,EB,1);

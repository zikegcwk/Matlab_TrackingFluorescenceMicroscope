function [atraces,D,Dnoise,gammac,gammap,L,noiseDensity,Istats,PlaserStats,StageStats]=analyzeTraces_smart_plot2(traces,givenParams,initGuess,savemode,savefile)
tic
...
%         Plaser=Plaser(ix);
        ...
        [dT, DX, DY, DZ,EB] = MSD3D_EB_smart(t,x,y,z);
         [D(i,:), noiseDensity(i,:), gammac(i,:), gammap(i,:), L(i,:), Dnoise(i,:),h] = msdfit3D_verysmart(dT, DX, DY, DZ,EB,givenParams,initGuess,1);

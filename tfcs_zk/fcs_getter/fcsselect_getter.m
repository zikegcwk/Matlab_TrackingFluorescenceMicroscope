...
% for j=1:1:size(real_dir_FCS,1)
%     cd(real_dir_FCS{1,j});
%     load(strcat(real_subdir{1,j},'.mat'))
%     [tau,g2{j,1},g2{j,2},g2{j,3},g2{j,4},g2{j,5},g2{j,6},g2{j,8},g2{j,9}]=FCS_ZK_select(siglist,taumin,taumax,tauN);

...
% Last Modified by GUIDE v2.5 04-Dec-2009 10:19:25
...
if browse_start<0
    %do nothing;
elseif browse_flag==1
   data_counter=find(data_number==browse_start);
   browse_flag=0;
end   
...
global FCS_begin;
FCS_begin=str2double(get(hObject,'String'));
...
global FCS_end;
FCS_end=str2double(get(hObject,'String'));
...
function browse_start_Callback(hObject, eventdata, handles)
% hObject    handle to browse_start (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of browse_start as text
%        str2double(get(hObject,'String')) returns contents of browse_start as a double

global browse_start;
global browse_flag;
browse_flag=1;
browse_start=str2double(get(hObject,'String'));

% --- Executes during object creation, after setting all properties.
function browse_start_CreateFcn(hObject, eventdata, handles)
% hObject    handle to browse_start (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
